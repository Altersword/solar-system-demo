...
**星图阶段 C 与后续克制扩充已完成**：`CELESTIAL_CATALOG` 现为 **108** 个目标
（邻域 32 / 银河 43 / 本星系群 17 / 宇宙近邻 16），并按图层提供尺度距离壳。
...
**下一优先**：
1. 可选：船帆座与红巨星/白矮星参数继续微调
2. 可选：相机飞入曲线与信息面板布局打磨
3. 可选：ES Module / 打包
4. 不建议：重写黑洞主路径、再冲 100+ 目录
